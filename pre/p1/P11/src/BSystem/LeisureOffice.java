...
public interface LeisureOffice  {
    ...
    /**
     * Reemplaza en el sistema al usuario viejo por el nuevo. Para que esto
     * suceda debe Cumplirse que el usuario viejo exista y que el nuevo no
     * incumpla normas relativas a las politicas de Usuarios (nick y/o edad)
     *
     * @param u El usuario
     ...
     *
     * @param nick
     * @return El usuario con el nick. Debe devolver null si existeNick(nick) es
     * falso.
     */
     ...
     * comentada. En caso deque alguno de los datos sea incorrecto, o
     * inexistente, el resultado sera false.
     *
     * @param u el usuario
     ...
     */
    /**
     * Añade una contestacion a una review, en caso de que la review exista y no
     * este ya comentada.
     *
     * @param c Contestacion a añadir
     * @param r Review
     * @return True si y solo si la operacion fue completada y se pudo añadir la
     * review.
     */
     ...
     */
    /**
     * Añade un local al sistema, siempre que no exista otro en la misma
     * direccion.
     *
    ...
    /**
     * Asocia un local a un propietario, en caso de que ambos existan y no se
     * haya llegado al limite de Propietarios por local
     *
     ...
     *
     * @param l Local existente en en sistema
     * @return Lista de reviews del sistema. En caso de que el Local no exista,
     * sera el valor null.
     */
     ...
     */
    /**
     * Anota una nueva reserva para un cliente dado, en un local reservable para
     * una fecha y hora concreta. El cliente y el local deben existir, y la
     * fecha y hora debe ser futura. El cliente no debe tener otra reserva para
     * el mismo local en la misma fecha.
     *
