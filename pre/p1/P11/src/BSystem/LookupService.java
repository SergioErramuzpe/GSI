...
public interface LookupService {
     ...
     * @return La valoración media de las reviews asociadas, o 0 si no existen
     * reviews.
     */
     ...
     * @return La valoración media de las reviews asociadas a sus locales, o 0
     * si no existen reviews.
     */
    public float obtenerValoracionMedia(Propietario p);

    /**
     * Obtiene la valoración media de un local realizadas por gente que, en el
     * momento de la valoración, estaba en un rango de edad determinado, o null
     * si éste no existe, o -1 si éste no existe.
     *
     * @param l Local de interés.
    ...
    /**
     * Obtiene los locales de una provincia ordenados por su valoración media en
     * las reviews asociadas. Los locales que no tienen reviews serán valorados
     * con 0.
     *
     * @param provincia Provincia en la que se encuentra la ciudad
     * @return Los locales ordenados por nota descendente
    ...
    /**
     * Obtiene los bares de una ciudad y provincia ordenados por su valoración
     * media en las reviews asociadas. Los locales que no tienen reviews serán
     * valorados con 0.
     *
     * @param ciudad Ciudad de interés
    ...
    /**
     * Obtiene los restaurantes de una ciudad y provincia ordenados por su
     * valoración media en las reviews asociadas. Los locales que no tienen
     * reviews serán valorados con 0.
     *
     * @param ciudad Ciudad de interés
     * @param provincia Provincia en la que se encuentra la ciudad
    ...
    /**
     * Obtiene los pubs de una ciudad y provincia ordenados por su valoración
     * media en las reviews asociadas. Los locales que no tienen reviews serán
     * valorados con 0.
     *
     * @param ciudad Ciudad de interés
